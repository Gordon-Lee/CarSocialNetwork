    ...
    func photoLibraryDidChange(_ changeInstance: PHChange) {
        ...
        DispatchQueue.main.async {
            ...
            if collectionChanges != nil {
                ...
                self.images = ((collectionChanges?.fetchResultAfterChanges as! PHFetchResult<AnyObject>!) as! PHFetchResult<PHAssetCollection>!) as! PHFetchResult<PHAsset>! //fetchResultAfterChanges
...
//        NSIndexSet.enumerate(self) {(idx, stop) in
//            indexPaths.append(IndexPath(row: idx, section: section))
//            //append(IndexPath(item: idx, section: section))
//        }
        return indexPaths
    }
}
